...
public class EnglishNoun
{
   ...
   public static void main(String[] args) {
	   ...
	   if(isSingular(word)==true){
		   System.out.println("is singular");
		   System.out.println(EnglishNoun.pluralOf(word));
	   }
	   if(isPlural(word)==true){
		   System.out.println("is plural");
		   System.out.println(EnglishNoun.singularOf(word));
	   }
	   /*
	   System.out.println(isSingular("buses"));
		
	   System.out.println(isPlural("buses"));
	   
		String s=EnglishNoun.singularOf("flies");
		System.out.println(s);
		
		String s1=EnglishNoun.pluralOf("fly");
